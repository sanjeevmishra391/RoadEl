...
public class LongestCommonSubsequence {
    ...
    LongestCommonSubsequence(String s1, String s2, Methods method, boolean use) {
        this.method = method;
    ...
    public static void main(String[] args) {
        ...
        new LongestCommonSubsequence(s1, s2, Methods.RECURSION, true);
        new LongestCommonSubsequence(s1, s2, Methods.TABULATION, true);
        new LongestCommonSubsequence(s1, s2, Methods.MEMOIZATION, true);
