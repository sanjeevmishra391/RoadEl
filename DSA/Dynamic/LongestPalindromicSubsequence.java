...
public class LongestPalindromicSubsequence {
    ...
    LongestPalindromicSubsequence(String s1, String s2, Methods method, boolean use) {
        this.method = method;
    ...
    static String algorithm() {
        System.out.println("-------------------------");
        System.out.println(Utility.CYAN + "Algorithm" + Utility.RESET);
        System.out.println("-------------------------");

        return "To find the longest common subsequence, find the length of the longest common subsequence between String s and reverse of string s." + "\n";
    }
    ...
    public static void main(String[] args) {
        ...
        new LongestPalindromicSubsequence(s1, s2, Methods.RECURSION, true);
        new LongestPalindromicSubsequence(s1, s2, Methods.TABULATION, true);
        new LongestPalindromicSubsequence(s1, s2, Methods.MEMOIZATION, true);
